    ...
    <div class="container">
      <ul class="list-philosophy">
        <li class="philosophy mission">
          <div class="box-text">
            <p class="label">Mission <span>使命</span></p>
            <h2 class="copy">
              声になる前の声をカタチに
            </h2>
            <p class="text">
        ...
        <li class="philosophy vision">
          <div class="box-text">
            <p class="label">Vision<span>展望</span></p>
            <h2 class="copy">
              建設をもっとおもしろく
            </h2>
            <p class="text">
          ...
          <img src="<?php echo get_template_directory_uri(); ?>/assets/imgs/company/vision-sp.png" alt="" class="image sp">
        </li>
        <li class="philosophy value">
          <div class="box-text">
            <p class="label">Value<span>価値観</span></p>
            <h2 class="copy">
              建設を共に楽しむ
            </h2>
            <p class="text">
          ...
          <img src="<?php echo get_template_directory_uri(); ?>/assets/imgs/company/value-sp.png" alt="" class="image sp">
        </li>
      </ul>
      <div class="box-illust pc">
        ...
        <img src="<?php echo get_template_directory_uri(); ?>/assets/imgs/company/vision.png" alt=""
          class="image step2">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/imgs/company/value.png" alt="" class="image step3">
      </div>
    </div>
  </section>
      ...
      <ul class="list-information">
        ...
        <li class="information">
          ...
          <p class="data">〒596-0831 大阪府岸和田市畑町4-3-7
            <a href="https://maps.app.goo.gl/QogWPKTC5NJxuggU6" class="link" target="_black">Google map<img src="<?php echo get_template_directory_uri(); ?>/assets/imgs/window.svg" alt=""
            class="icon"></a></p>
        </li>
        <li class="information">
