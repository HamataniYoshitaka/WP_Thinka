...
!function (e, t) {
  ...
  function lt() {
    it && (!1 === E.hidden && C.requesttionFrame ? C.requesttionFrame(lt) : C.setTimeout(lt, k.fx.interval), k.fx.tick());
  }
  ...
  k.tion = k.extend(dt, {
    ...
    fadeTo: function (e, t, n, r) {
      return this.filter(se).css("opacity", 0).show().end().te({
        opacity: t
      }, e, n, r);
    },
    te: function (t, e, n, r) {
    ...
    k.fn[r] = function (e, t, n) {
      return null == e || "boolean" == typeof e ? i.apply(this, arguments) : this.te(ft(r, !0), e, t, n);
    };
  }), k.each({
    slideDown: ft("show"),
    slideUp: ft("hide"),
